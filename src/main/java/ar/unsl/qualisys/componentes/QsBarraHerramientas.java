...
public class QsBarraHerramientas extends JToolBar{
    ...
    public QsBarraHerramientas(QsFrame parentt,QsTextPanel panelDeTexto,QualyGraphicPanel panelDeGraficos,JPanel panelDeInstancias,JPanel panelDeResultados) {
        this.parent = parentt;
      ...
      //  JToolBar menuHerramientas = new JToolBar();
        ...
        siguiente.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                System.out.println("Siguiente");               //Read Only
                parent.setTURN_OFF_LISTENERS(true);         
                // SET READ ONLY 
