...
public class QsOperatorsPanel extends JPanel {
    ...
    public QsOperatorsPanel(QsGraphicPanel parent) {
        ...
        operador1= new QsOperador(this,"Disjunction","D",1d,1.7e+103d,1.7e+103d,1.7e+103d,1.7e+103d);
        operador1.setBackground(Color.decode("#A3A380"));
        operadorBySymbol.put(operador1.getSymbol(),operador1);
        operador2= new QsOperador(this,"Strong QD (+)","D++",0.9375d,20.630d,24.300d,27.110d,30.090d);
        operador2.setBackground(Color.decode("#A3A380"));
        operadorBySymbol.put(operador2.getSymbol(),operador2);
        operador3= new QsOperador(this,"Strong QD","D+",0.8750d,9.521d,11.095d,12.270d,13.235d);
        operador3.setBackground(Color.decode("#A3A380"));
        operadorBySymbol.put(operador3.getSymbol(),operador3);
        operador4= new QsOperador(this,"Strong QD (-)","D+-",0.8125d,5.802d,6.675d,7.316d,7.819d);
        operador4.setBackground(Color.decode("#A3A380"));
        operadorBySymbol.put(operador4.getSymbol(),operador4);
        operador5= new QsOperador(this,"Medium QD","DA",0.7500d,3.929d,4.450d,4.825d,5.111d);
        operador5.setBackground(Color.decode("#A3A380"));
        operadorBySymbol.put(operador5.getSymbol(),operador5);
        operador6= new QsOperador(this,"Weak QD (+)","D-+",0.6875d,2.792d,3.101d,3.318d,3.479d);
        operador6.setBackground(Color.decode("#A3A380"));
        operadorBySymbol.put(operador6.getSymbol(),operador6);
        operador7= new QsOperador(this,"Weak QD","D-",0.6250d,2.018d,2.187d,2.302d,2.384d);        
        operador7.setBackground(Color.decode("#A3A380"));
        operadorBySymbol.put(operador7.getSymbol(),operador7);
        operador8= new QsOperador(this,"Square Mean","SQU",0.6232d,2.000d,2.00d,2.00d,2.00d);        
        operador8.setBackground(Color.decode("#A3A380"));
        operadorBySymbol.put(operador8.getSymbol(),operador8);
        operador9= new QsOperador(this,"Weak QD (-)","D--",0.5625d,1.449d,1.519d,1.565d,1.596d);        
        operador9.setBackground(Color.decode("#A3A380"));
        operadorBySymbol.put(operador9.getSymbol(),operador9);
        operador10= new QsOperador(this,"Arithmetic Mean","A",0.5d,1.00d,1.00d,1.00d,1.00d);        
        operador10.setBackground(Color.decode("#A3A380"));
        operadorBySymbol.put(operador10.getSymbol(),operador10);
        operador11= new QsOperador(this,"Weak QC (-)","C--",0.4375d,0.619d,0.573d,0.546d,0.526d);        
        operador11.setBackground(Color.decode("#D8A48F"));
        operadorBySymbol.put(operador11.getSymbol(),operador11);
        operador12= new QsOperador(this,"Weak QC","C-",0.3750d,0.261d,0.192d,0.153d,0.129d);                
        operador12.setBackground(Color.decode("#D8A48F"));
        operadorBySymbol.put(operador12.getSymbol(),operador12);
        operador13= new QsOperador(this,"Geometric Mean","GEO",0.3333d,0d,-0.067d,-0.101d,-0.121d);      
        operador13.setBackground(Color.decode("#D8A48F"));
        operadorBySymbol.put(operador13.getSymbol(),operador13);
        operador14= new QsOperador(this,"Weak QC (+)","C-+",0.3125d,-0.148d,-0.208d,-0.235d,-0.251d);        
        operador14.setBackground(Color.decode("#D8A48F"));
        operadorBySymbol.put(operador14.getSymbol(),operador14);
        operador15= new QsOperador(this,"Medium QC","CA",0.2500d,-0.720d,-0.732d,-0.721d,-0.707d);        
        operador15.setBackground(Color.decode("#D8A48F"));
        operadorBySymbol.put(operador15.getSymbol(),operador15);
        operador16= new QsOperador(this,"Harmonic Mean","HAR",0.2274d,-1.000d,-1.000d,-1.000d,-1.000d);        
        operador16.setBackground(Color.decode("#D8A48F"));
        operadorBySymbol.put(operador16.getSymbol(),operador16);
        operador17= new QsOperador(this,"Strong QC (-)","C+-",0.1875d,-1.655d,-1.550d,-1.455d,-1.380d);        
        operador17.setBackground(Color.decode("#D8A48F"));
        operadorBySymbol.put(operador17.getSymbol(),operador17);
        operador18= new QsOperador(this,"Strong QC","C+",0.1250d,-3.510d,-3.114d,-2.823d,-2.606d);        
        operador18.setBackground(Color.decode("#D8A48F"));
        operadorBySymbol.put(operador18.getSymbol(),operador18);
        operador19= new QsOperador(this,"Stronc QC (+)","C++",0.0625d,-9.060d,-7.639d,-6.689d,-6.013d);        
        operador19.setBackground(Color.decode("#D8A48F"));
        operadorBySymbol.put(operador19.getSymbol(),operador19);
        operador20= new QsOperador(this,"Conjunction","C",0.0000d,5.0e-324d,5.0e-324d,5.0e-324d,5.0e-324d);
        operador20.setBackground(Color.decode("#D8A48F"));
